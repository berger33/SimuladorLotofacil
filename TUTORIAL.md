...
### 🤖 IA Autônoma (Q-Learning configs)
Você não sabe se deve colocar a Mutação em 5% ou 15%? 
Ative isso! A Inteligência Artificial (Reinforcement Learning) vai assumir os controles. Ela vai testar a Mutação alta, vai ver que deu prejuízo, vai se punir, e vai trocar sozinha para Mutação baixa. Ela guarda na memória (`storage/rl_qtable.json`) o que funciona. Deixe rodando por horas e o software ficará incrivelmente inteligente.
...
3. Ative **🤖 IA Autônoma (Q-Learning)**
...
**A Q-Table da IA Autônoma reseta se eu fechar o programa?**
Não! Ela salva o aprendizado em `storage/rl_qtable.json`. O seu robô manterá o aprendizado das madrugadas passadas.
